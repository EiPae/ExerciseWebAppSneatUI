...
namespace ExerciseWebAppSneatUI.Controllers
{
    ...
    public class AccountUsersController : Controller
    {
        ...
        public AccountUsersController(ExerciseWebAppSneatUiContext context)
        {
            _context = context;
        }
        ...
        {
            ViewBag.pagename = "menuAccountUser";
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password,Email,PhoneNumber,Address")] AccountUser accountUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Password,Email,PhoneNumber,Address")] AccountUser accountUser)
        {
